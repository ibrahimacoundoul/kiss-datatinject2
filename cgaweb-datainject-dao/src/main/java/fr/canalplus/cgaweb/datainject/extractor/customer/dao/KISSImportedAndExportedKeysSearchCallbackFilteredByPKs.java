...
public class KISSImportedAndExportedKeysSearchCallbackFilteredByPKs extends ImportedAndExportedKeysSearchCallback {
	 ...
	 *            that table)
	 */
	public KISSImportedAndExportedKeysSearchCallbackFilteredByPKs(IDatabaseConnection connection, PkTableMap allowedPKs) {
		super(connection);
		this.pksFilter = new KISSPrimaryKeyFilter(connection, allowedPKs, true);
	}
